        ...
        { 
            ...
            <footer className='foot'>
                <div className='contain'>
                        ...
                        <summary className ="main-container__s2__details__summary">TE AYUDAMOS<img className='main-container__s2__details__icon' src="https://www.iconpacks.net/icons/2/free-arrow-down-icon-3101-thumb.png" alt="" /> </summary>
                            <p className="main-container__s2__details__paragraph"> Preguntas frecuentes <br /> Garantía de productos <br />
                            Cambios y devoluciones <br /> Contáctanos</p>
                        </details>
                        <details className ="main-container__s2__details">
                        <summary className ="main-container__s2__details__summary">INFORMACIÓN LEGAL<img className='main-container__s2__details__icon' src="https://www.iconpacks.net/icons/2/free-arrow-down-icon-3101-thumb.png" alt="" /> </summary>
                            <p className="main-container__s2__details__paragraph"> Términos y condiciones uso sitio web  <br /> Política de tratamiento de la información personal <br />
                            Términos y condiciones <br /> Promociones <br /> Derecho de retracto <br /> Superintendencia <br /> 
                            Industria y Comercio - SIC <br /> Autorización tratamiento de datos</p>
                        </details>

                        <details className ="main-container__s2__details">
                        <summary className ="main-container__s2__details__summary">MI CUENTA<img className='main-container__s2__details__icon' src="https://www.iconpacks.net/icons/2/free-arrow-down-icon-3101-thumb.png" alt="" /> </summary>
                            <p className="main-container__s2__details__paragraph">Iniciar sesión <br /> Rastrea pedido</p>
                        </details>

                        <details className ="main-container__s2__details">
                        <summary className ="main-container__s2__details__summary">ACERCA DE MOVIES<img className='main-container__s2__details__icon' src="https://www.iconpacks.net/icons/2/free-arrow-down-icon-3101-thumb.png" alt="" /> </summary>
                            <p className="main-container__s2__details__paragraph">Nuestra historia<br />Trabaja con nosotros</p>
                        </details>
                </div>
                <p className="derechos">
                    ...
                    <img src="https://www.moviesshop.co/arquivos/ssl-secure.svg" width="69px" height="16px" alt="" />
                </p>
            </footer>  
            : <footer className='foot'>
                <div className='contain'>
